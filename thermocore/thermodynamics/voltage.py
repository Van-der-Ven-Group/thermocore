...
def intercalation_chemical_potential(
    data: dict, number_of_intercalant_per_unit_cell: int
) -> np.ndarray:
    """
...
def intercalation_voltage(
    data: dict,
    refernce_chemical_potential: float,
    number_of_intercalant_per_unit_cell: int,
...
def GCMC_intercalation_voltage(
    GCMC_data: dict,
    refernce_chemical_potential: float,
